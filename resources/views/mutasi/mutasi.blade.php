...
<div class="text-center">
    <h1>MUTASI (PINDAH-DATANG) ASN</h1>
</div>
<hr class="mt-2 featurette-divider">
@if ($mutasi->count())
<div class="card mb-4 mt-3">
    <img src="# {{ $mutasi[0]->category->nama }}" class="card-img-top" alt="{{ $mutasi[0]->category->nama }}">
    <div class="card-body text-center">
        <h3 class="card-title">{{ $mutasi[0]->title }}</h3>
        <p>
            <small class="text-muted">
                By. <a href="#" class="text-decoration-none">{{ $mutasi[0]->user->name }}</a> in <a href="/categories/{{ $mutasi[0]->category->slug }}" class="text-decoration-none">{{ $mutasi[0]->category->nama }}</a>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3 mt-3">
            <div class="card">
                ...
                <img src="# {{ $mutasib->category->nama }}" class="card-img-top" alt="{{ $mutasib->category->nama }}">
                <div class="card-body">
