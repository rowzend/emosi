	...
	<div class="form-main-container">
		<div class="form-wrapper-register">
			...
			<form class="form-content" method="POST" action="{{ route('register') }}">
				...
				<div class="input-wrapper">
					<div class="input-group">
						<input id="combobox" type="combobox" placeholder="Pilih Layanan" class="form-control @error('combobox') is-invalid @enderror" name="combobox" required autocomplete="combobox">
						@error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
